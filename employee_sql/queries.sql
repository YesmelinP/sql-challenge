...
SELECT first_name, last_name, EXTRACT (YEAR FROM hire_date) AS "year"
FROM employees
...
SELECT dept_manager.emp_no, dept_manager.dept_no, departments.dept_name, employees.first_name, employees.first_name
FROM dept_manager
...
SELECT last_name, COUNT(emp_no) AS "count_shared_last_name"
FROM employees
GROUP BY last_name
